...
[![Travis build status](https://travis-ci.org/jjesusfilho/tjdft.svg?branch=master)](https://travis-ci.org/jjesusfilho/tjdft)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/jjesusfilho/tjdft?branch=master&svg=true)](https://ci.appveyor.com/project/jjesusfilho/tjdft)
